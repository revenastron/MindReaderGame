...
export default class Page5 extends Component {
  ...
  render() {
    const { count,flag } = this.props.route.params;
     const data=[
      { id: 1, title: 'Shane Watson' },
      { id: 2, title: 'AB de Villiers' },
      { id: 3, title: 'MS Dhoni' },
      {id: 4, title:'Jimmy Anderson'},
      { id: 5, title: 'Jos Buttler' }
     ]
           ...
           <View style={{display:'flex',flexDirection:'row', marginTop:40}} >
              <TouchableOpacity style={{backgroundColor:"#75E6DA",
                  ...
                  shadowColor: '#000',
                      ...
                      shadowRadius: 4,
                      elevation: 5}} onPress={() =>
                                this.props.navigation.navigate('Result', { count: count + 4, flag: flag + 2 })
                              }>
                  <Text>YES</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity style={{
                  ...
                  shadowColor: '#000',
                      ...
                      shadowRadius: 4,
                      elevation: 5}} onPress={() =>
                                this.props.navigation.navigate('Result', { count: count, flag: flag })
                              }>
                  <Text>NO</Text>
                </TouchableOpacity>
              </View>
