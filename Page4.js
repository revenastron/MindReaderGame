...
export default class Page4 extends Component {
  ...
  render() {
    const { count } = this.props.route.params;
     const data=[
      { id: 1, title: 'AB de Villiers' },
      { id: 2, title: 'Rohit' },
      { id: 3, title: 'Shane Watson' },
      { id: 4, title: 'Faf du plesis' },
      { id: 5, title: 'MS Dhoni' },
      { id: 6, title:'Jimmy Anderson'}
     ]
    return (
       <LinearGradient style={{flex:1, paddingTop:30}} colors={["#05445E","#189AB4" ]}>
            ...
            <FlatList
              data={data}
            renderItem={({item}) => <Text style={{fontSize:22,color:"#000",marginLeft:35,marginTop:12}}>{item.id}) {item.title}</Text>}
              />
              </View>
               ...
               <View style={{display:'flex',flexDirection:'row', marginTop:40}} >
                  <TouchableOpacity style={{backgroundColor:"#75E6DA",
                        ...
                        shadowColor: '#000',
                            ...
                            shadowRadius: 4,
                            elevation: 5}}  onPress={() =>
                                      this.props.navigation.navigate('Qn5', { count: count + 3, flag: 1 })
                                    }>
                        <Text>YES</Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity style={{
                        ...
                        shadowColor: '#000',
                            ...
                            shadowRadius: 4,
                            elevation: 5}}  onPress={() =>
                                      this.props.navigation.navigate('Qn5', { count: count, flag: 0 })
                                    }>
                        <Text>NO</Text>
                    </TouchableOpacity>
                  </View>
